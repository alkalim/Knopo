...
- **Left sidebar**: Journal (home), Favourites, Recents, Tags, All Pages. The Favourites, Recents, and Tags sections are collapsible (state persisted) and capped at 15 entries each in v1. All Pages shows unnamespaced regular pages in a collapsible Pages section, followed by collapsible namespace sections, then journal pages in a final collapsible Journal section with formatted date titles and newest days first. All Pages sections start expanded, save their collapse state per graph, and temporarily reveal matching rows while filtering without changing that saved state.
