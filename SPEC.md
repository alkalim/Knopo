...
- **Left sidebar**: Journal (home), Favourites, Recents, Tags, All Pages. The Favourites, Recents, and Tags sections are collapsible (state persisted) and capped at 15 entries each in v1. All Pages groups journal pages in their own Journal section, with formatted date titles and newest days first; unnamespaced regular pages appear in a separate Pages section.
