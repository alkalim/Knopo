...
/// knopo://page/<name>, knopo://block/<uuid>, knopo://tag/<name>
enum KnopoURL {
    static func page(_ name: String) -> URL {
        URL(string: "knopo://page/\(name.addingPercentEncoding(withAllowedCharacters: .alphanumerics) ?? name)")!
    }

    static func block(_ id: UUID) -> URL {
        URL(string: "knopo://block/\(id.uuidString.lowercased())")!
    }
    ...
    static func block(_ id: UUID, onPage name: String) -> URL {
        ...
        return URL(string: "knopo://page/\(encoded)?block=\(id.uuidString.lowercased())")!
    }
    ...
    static func decode(_ url: URL) -> NavTarget? {
        ...
        switch url.host {
        case "page":
            // `knopo://page/<name>?block=<uuid>` zooms into that block.
